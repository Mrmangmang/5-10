         ...
         <el-col :span="6" v-for="(item,index) in counts" :key="index">
             <el-card class="box-card" shadow="hover">
                 <div class="d-flex align-items-center">
                     <i  :class="[item.icon,item.color]"  class="mr-3  h4 mb-0  text-white text-center" style="width:40px;height: 40px;text-align: center;line-height: 40px"></i>
                     <div>
               ...
               <el-card class="box-card">
                   ...
                   <div class="media  border align-items-center" >
                       ...
                       <div class="media-body">
                           <div class="border-bottom pl-3 pb-2 mb-2"><span>订单量</span>12</div>
                           <div class="pl-3"><span>订单量</span>12</div>
                       </div>
                   </div>
        ...
        data(){
            return {
               tableData:[
                ...
                counts:[
                    {icon:"el-icon-user-solid",num:"30",desc:"关注人数",color:'bg-primary'},
                    {icon:"el-icon-s-finance",num:"120",desc:"订单总数" ,color: 'bg-success'},
                    {icon:"el-icon-s-order",num:"41",desc:"今日订单总金额",color:'bg-danger'},
                    {icon:"el-icon-s-data",num:"300",desc:"本月销量",color:'bg-warning'}
                ],
                tips:[
                    {
                        title:'店铺及商品提示',
